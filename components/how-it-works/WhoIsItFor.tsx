      ...
      <div className="mx-auto max-w-6xl px-6 space-y-16">
        ...
        <div>
          <motion.div
            ...
            className="mb-12"
          >
            <p className="mb-2 text-xs font-500 uppercase tracking-[0.15em] text-primary">Who It's For</p>
            <h2 className="font-display text-4xl font-700 text-text">Built for everyone who keeps birds</h2>
          </motion.div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {cards.map((c, i) => (
              ...
              >
                ...
                <h3 className="font-display text-xl font-700 text-text">{c.title}</h3>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-relaxed text-amber-700">
                ...
                Built as part of the Global Fusion Hackathon 2026.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <p className="mt-3 text-white/75">Free. No signup. Just upload and chat.</p>
          <Link
            href="/chat"
